...
// /api/podcasts/comments/#podcast_id
module.exports = async (req, res) => {
    ...
    if (!token) {
        try {
            ...
            res.status(500).json({'message': `Error retrieving summary of comments for podcast at ID ${id} during database operation`});
        }
    }
     else {
        try {
